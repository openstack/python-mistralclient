...
# Upper constraint file contains mistralclient version pin that is in
# conflict with installing mistral from source. We should replace
# the version pin in the constraints file before applying it for from-source
# installation.

ZUUL_CLONER=/usr/zuul-env/bin/zuul-cloner
BRANCH_NAME=master
MODULE_NAME=python-mistralclient
